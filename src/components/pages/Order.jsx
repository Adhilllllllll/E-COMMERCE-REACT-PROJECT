  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white mt-7 shadow rounded-lg p-6">
        ...
        <div className="mb-6">
          <p className="text-gray-700"><strong>Order ID:</strong> {order._id || order.id}</p>
          <p className="text-gray-700">
            <strong>Date:</strong>{" "}
            {displayDate.toLocaleString("en-IN", { timeZone: "Asia/Kolkata" })}
          </p>
          ...
          {order.paymentMethod && (
            <p className="text-gray-700"><strong>Payment:</strong> {order.paymentMethod.toUpperCase()}</p>
          )}
        </div>
        ...
        <div className="border-t pt-4">
          <h2 className="text-xl font-semibold">
            Total: ${order.totalPrice?.toFixed(2) || order.total?.toFixed(2)}
          </h2>
        </div>
